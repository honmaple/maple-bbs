...
# Last Update:星期日 2016-11-13 0:2:8 (CST)
#          By:
# Description:
# **************************************************************************
...
class NoticeView(MethodView):
    ...
    def get(self):
        ...
        unread_notices = Notice.query.filter_by(
            rece_id=current_user.id, is_read=False).all()
        if unread_notices:
